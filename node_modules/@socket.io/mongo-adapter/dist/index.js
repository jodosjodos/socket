...
class MongoAdapter extends socket_io_adapter_1.Adapter {
    ...
    async restoreSession(pid, offset) {
        ...
        const result = (((_d = results[0]) === null || _d === void 0 ? void 0 : _d.ok)
        ...
        try {
            try {
                for (var _g = true, cursor_1 = __asyncValues(cursor), cursor_1_1; cursor_1_1 = await cursor_1.next(), _a = cursor_1_1.done, !_a;) {
                    _c = cursor_1_1.value;
                    _g = false;
                    try {
                        const document = _c;
                        const packetData = (_f = (_e = document === null || document === void 0 ? void 0 : document.data) === null || _e === void 0 ? void 0 : _e.packet) === null || _f === void 0 ? void 0 : _f.data;
                        if (packetData) {
                ...
                try {
                    if (!_g && !_a && (_b = cursor_1.return)) await _b.call(cursor_1);
                }
