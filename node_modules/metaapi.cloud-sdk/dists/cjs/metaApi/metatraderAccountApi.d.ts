...
export default class MetatraderAccountApi {
  ...
  /**
   * Returns trading accounts, provides pagination in infinite scroll style
   ...
   */
  getAccountsWithInfiniteScrollPagination(accountsFilter?: AccountsFilter): Promise<Array<MetatraderAccount>>;

  /**
   * Returns trading accounts and count, provides pagination in a classic style
   * @param {AccountsFilter} [accountsFilter] optional filter
   * @return {Promise<MetatraderAccountList>} promise resolving with an array of MetaTrader account entities and count
   */
  getAccountsWithClassicPagination(accountsFilter?: AccountsFilter): Promise<MetatraderAccountList>;
 ...
 */
export declare type MetatraderAccountList = {
